...
class CreateExerciseRequestSchema(BaseModel):
    ...
    order_index: int = Field(alias="orderIndex", default_factory=lambda: fake.integer(0, 100))
...
class UpdateExerciseRequestSchema(BaseModel):
    ...
    order_index: int | None = Field(default_factory=lambda: fake.integer(0, 100), alias="orderIndex")
